        ...
        <StyledAppBar position="fixed" elevation={0}>
            <Toolbar variant="dense">
                <BannerBox>
                    ...
                    <TitleTextBox>
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" className="bi bi-globe-americas bootstrap-icon-fill-code" viewBox="0 0 16 16">
                    ...
                    >
                        <IconDataText>
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" class="bi bi-pin-map bootstrap-icon-fill-code" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M3.1 11.2a.5.5 0 0 1 .4-.2H6a.5.5 0 0 1 0 1H3.75L1.5 15h13l-2.25-3H10a.5.5 0 0 1 0-1h2.5a.5.5 0 0 1 .4.2l3 4a.5.5 0 0 1-.4.8H.5a.5.5 0 0 1-.4-.8z"/>
                                <path fill-rule="evenodd" d="M8 1a3 3 0 1 0 0 6 3 3 0 0 0 0-6M4 4a4 4 0 1 1 4.5 3.969V13.5a.5.5 0 0 1-1 0V7.97A4 4 0 0 1 4 3.999z"/>
                            </svg>
                            <DataText>
                                <span className='titlebox-data'>{0}</span> insights pinned
                            </DataText>
                        </IconDataText>

                        <IconDataText>
                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" className="bi bi-database bootstrap-icon-fill-code" viewBox="0 0 16 16">
                            ...
                            <DataText>
                                <span className='titlebox-data'>{(numTokens?.toLocaleString()) ?? 0}</span> tokens mapped
                            </DataText>
                        </IconDataText>
                        ...
                        <IconDataText>
                            ...
                            <DataText>
                                <span className='titlebox-data'>{(numAncestors?.toLocaleString()) ?? 0}</span> ancestors charted
                            </DataText>
                        </IconDataText>
