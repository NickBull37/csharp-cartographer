                ...
                >
                    ...
                    >
                        ...
                        <FlexBox
                            ...
                            gap={1}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" className="bi bi-diagram-3 bootstrap-icon-fill-code" viewBox="0 0 16 16">
                        ...
                        >
                            ...
                            <DataText>
                                <span className='titlebox-data'>{generationTime}</span> time to generate
                            </DataText>
                        </FlexBox>
                    </FlexBox>
